...
export type ClimbingRouteResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["ClimbingRoute"] =
    ResolversParentTypes["ClimbingRoute"],
> = {
...
export type HikingTrailResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["HikingTrail"] =
    ResolversParentTypes["HikingTrail"],
> = {
  allClimbsonTrailDiff?: Resolver<
    Array<Maybe<ResolversTypes["VScale"]>>,
    ParentType,
    ContextType
  >;
  climbingRoutes?: Resolver<
    Maybe<Array<Maybe<ResolversTypes["ClimbingRoute"]>>>,
    ParentType,
    ContextType
  >;
  difficulty?: Resolver<
    ResolversTypes["DificultyRanking"],
    ParentType,
    ContextType
  >;
...
> = {
  getClimbsByHikingTrail?: Resolver<
    Maybe<Array<Maybe<ResolversTypes["ClimbingRoute"]>>>,
    ParentType,
    ContextType,
    RequireFields<QueryGetClimbsByHikingTrailArgs, "trailName">
  >;
  getHikingTrailByDifficulty?: Resolver<
    Maybe<Array<ResolversTypes["HikingTrail"]>>,
    ParentType,
    ContextType,
    RequireFields<QueryGetHikingTrailByDifficultyArgs, "difficulty">
  >;
  getHikingTrailByName?: Resolver<
    Maybe<ResolversTypes["HikingTrail"]>,
    ParentType,
    ContextType,
    RequireFields<QueryGetHikingTrailByNameArgs, "trailName">
  >;
  getHikingTrailsByRating?: Resolver<
    Maybe<Array<ResolversTypes["HikingTrail"]>>,
    ParentType,
    ContextType,
    RequireFields<QueryGetHikingTrailsByRatingArgs, "rating">
  >;
  getPeopleByClimb?: Resolver<
    Maybe<Array<Maybe<ResolversTypes["Person"]>>>,
    ParentType,
    ContextType,
    RequireFields<QueryGetPeopleByClimbArgs, "routeName">
  >;
};
